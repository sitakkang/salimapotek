...
class Ciqrcode
{
	...
	public function initialize($config = array()) {
        ...
        $this->cachedir = (isset($config['cachedir']))
            ? $config['cachedir']
            : rtrim(APPPATH, DIRECTORY_SEPARATOR).DIRECTORY_SEPARATOR.trim($this->cachedir, '/\\').DIRECTORY_SEPARATOR;
        $this->errorlog = (isset($config['errorlog']))
            ? $config['errorlog']
            : rtrim(APPPATH, DIRECTORY_SEPARATOR).DIRECTORY_SEPARATOR.trim($this->errorlog, '/\\').DIRECTORY_SEPARATOR;
