...
<div class="ds-form-group">
    ...
    <input type="text" id="edit_skbs_docnumb" name="skbs_docnumb" class="form-control" maxlength="100"
           value="<?= htmlspecialchars(!empty($row->skbs_docnumb) ? $row->skbs_docnumb : ($skbs_docnumb_default ?? '00000/SKBS/PDUKRWP/ASM')) ?>">
</div>
...
<div class="row" style="margin: 0 -6px;">
    ...
    <div class="col-md-3" style="padding: 0 6px;">
        <div class="ds-form-group">
            ...
            <input type="text" id="edit_skbs_bod" name="skbs_bod" class="form-control date-mask"
